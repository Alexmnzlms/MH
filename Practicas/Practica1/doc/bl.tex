...
Como ya he explicado anteriormente, el objetivo de la bísqueda local es minimizar tanto la desviación general de los elementos, como el número de restricciones incumplidas, si embargo se introduce un parametro de escalado $ \lambda $ como una manera de dar relevancia a la infactibilidad.\\
